...
abstract class SplayRepository {
  ...
  Future<Either<Failure, String>> insertDirectorySaved({required DirectorySavedEntity directory});
  Future<Either<Failure, String>> removeDirectorySaved({required DirectorySavedEntity directory});
  Future<bool> isAddedToSavedDirectory({required String id});
  Future<Either<Failure, DirectorySavedEntity>> getDirectorySavedById({required String id});
